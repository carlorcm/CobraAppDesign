...
$(document).ready(function() {
    ...
    function init_template() {
        ...
        function activate_pageGreeting() {
            ...
            if (month < 10) {
                $('.greeting-text-time').html(`${day}-0${month}-${year} <br> Ruta`);
                $('.greeting-text-time-only').html(`${day}-0${month}-${year}`);
            } else {
                $('.greeting-text-time').html(`${day}-${month}-${year} <br> Ruta`);
                $('.greeting-text-time-only').html(`${day}-${month}-${year}`);
            }
        }
